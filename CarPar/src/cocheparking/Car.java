...
/*
*ERRORES
*Los métodos no están declarados como static en el main
*Los Strings estaban mal escritos
*Habia un "for" separado con comas(,) en vez de punto y coma(;)
*Existían "imports" que no se usaban java.util.Arrays y java.awt.Color
*el método car.printGarage() debe ser g.printGarage()
*el "sout" de Garage estaba mal escrito
*/